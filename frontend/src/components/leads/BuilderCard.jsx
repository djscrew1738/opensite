      ...
      <div className="card-body space-y-3">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              {builder.company && builder.name && (
                <p className="text-xs text-surface-500 dark:text-surface-400 truncate">{builder.company}</p>
              )}
            </div>
          </div>

          {/* Trend */}
          <div className={`flex items-center gap-1 px-2 py-1 rounded-lg text-xs font-semibold ${trend.color} bg-concrete-50 dark:bg-surface-800`}>
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="text-center p-2 rounded-lg bg-concrete-50 dark:bg-surface-800">
            <p className="text-lg font-bold text-surface-900 dark:text-surface-100 tabular-nums">{builder.totalPermits || 0}</p>
            <p className="text-2xs font-semibold text-surface-500 dark:text-surface-400 uppercase tracking-wider">Total</p>
          </div>
          <div className="text-center p-2 rounded-lg bg-concrete-50 dark:bg-surface-800">
            <p className="text-lg font-bold text-surface-900 dark:text-surface-100 tabular-nums">{builder.permitsLast30d || 0}</p>
            <p className="text-2xs font-semibold text-surface-500 dark:text-surface-400 uppercase tracking-wider">30d</p>
          </div>
          <div className="text-center p-2 rounded-lg bg-concrete-50 dark:bg-surface-800">
            <p className="text-lg font-bold text-surface-900 dark:text-surface-100 tabular-nums">{builder.permitsLast90d || 0}</p>
            <p className="text-2xs font-semibold text-surface-500 dark:text-surface-400 uppercase tracking-wider">90d</p>
          </div>
        </div>
