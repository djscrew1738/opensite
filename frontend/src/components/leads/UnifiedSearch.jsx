            ...
            {!query || query.length < 2 ? (
              ...
              <div className="py-1">
                ...
                {results?.permits?.length > 0 && (typeFilter === 'all' || typeFilter === 'permits') && (
                  <>
                    <div className="px-5 py-2">
                      <span className="text-2xs font-bold uppercase tracking-widest text-gray-400">Permits</span>
                    </div>
                ...
                {results?.leads?.length > 0 && (typeFilter === 'all' || typeFilter === 'leads') && (
                  <>
                    <div className="px-5 py-2">
                      <span className="text-2xs font-bold uppercase tracking-widest text-gray-400">Leads</span>
                    </div>
                    {results.leads.map((r) => {
                ...
                {results?.builders?.length > 0 && (typeFilter === 'all' || typeFilter === 'builders') && (
                  <>
                    <div className="px-5 py-2">
                      <span className="text-2xs font-bold uppercase tracking-widest text-gray-400">Builders</span>
                    </div>
