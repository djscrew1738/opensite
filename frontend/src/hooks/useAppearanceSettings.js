...
/**
 * Manages appearance preferences stored in localStorage (theme, density, formats).
 * No server round-trip needed — all values are local.
 */
export function useAppearanceSettings({ showToast }) {
